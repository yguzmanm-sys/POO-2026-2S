...
\begin{titlepage}
    ...
    {\LARGE \textbf{Universidad}}\\[0.4cm]
    {\large Facultad de Ingenier\'ia}\\[0.2cm]
    {\large Programa de Ingenier\'ia de Sistemas}\\[2cm]
    ...
    \begin{tabular}{rl}
        ...
        \textbf{Estudiante:}  & [Nombre completo del estudiante] \\[0.3cm]
...
El c\'odigo fuente de la Actividad 1 se encuentra en:
\begin{center}
    \large\url{https://github.com/yguzmanm-sys/POO-2026-2S}
\end{center}
